...
export const CvIcon = () => {
  return (
    ...
    >
      <path d="M7 18H17V16H7V18Z" className="fill-black dark:fill-white" />
      <path d="M17 14H7V12H17V14Z" className="fill-black dark:fill-white" />
      <path d="M7 10H11V8H7V10Z" className="fill-black dark:fill-white" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
export const DevIcon = () => {
  return (
    <svg
      className="size-7 hover:scale-125 transition-transform duration-500 ease-out"
      xmlns="http://www.w3.org/2000/svg"
      width="28"
      height="28"
      viewBox="0 0 24 24"
