  ...
  return (
    <div className="grid place-items-center border border-slate-600 rounded-lg px-4 py-6 sm:px-8 sm:py-10 my-32">
      <div className="grid grid-rows-2 place-items-center text-center">
        <h2 className="text-3xl font-bold tracking-tight text-theme-primary-light dark:text-theme-primary-dark sm:text-4xl mb-3">
          Personas que me inspiran
        </h2>
        <p className="z-20 leading-normal sm:text-lg sm:leading-7 md:max-w-[65%] text-neutral-600 dark:text-neutral-400">
